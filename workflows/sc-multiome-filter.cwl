...
inputs:
  ...
  filtered_feature_bc_matrix_folder:
    ...
    doc: |
      ...
      in a form of a single compressed
  ...
  grouping_data:
    ...
    doc: |
      If the selected "Cell Ranger RNA+ATAC
      ...
      output generated by "Cell Ranger RNA+ATAC
  ...
  barcodes_data:
    ...
    doc: |
      ...
      from "Cell Ranger RNA+ATAC Sample" and
      can be utilized in the current or future
      steps of analysis.
  ...
  call_by:
    ...
    doc: |
      ...
      generated by Cell Ranger RNA+ATAC Sample.
    "sd:layout":
      advanced: true
  ...
  minimum_umis:
    ...
    doc: |
      ...
      generated by "Cell Ranger RNA+ATAC
      Sample" and accessible on the "Files"
      tab. Any 0 will be replaced with the
      auto-estimated threshold (median -
  ...
  maximum_mito_perc:
    ...
    doc: |
      ...
      Set to 0 for using an auto-estimated
      threshold equal to the maximum among
      (median + 2 * MAD) values calculated
      per dataset.
      Default: 5
    "sd:layout":
      advanced: true
...
outputs:
  ...
  raw_cell_cnts_plot_png:
    type: File?
    outputSource: sc_multiome_filter/raw_cell_cnts_plot_png
  ...
  raw_umi_mito_plot_png:
    type: File?
    outputSource: sc_multiome_filter/raw_umi_mito_plot_png
  ...
  raw_rna_atac_cnts_plot_png:
    ...
    label: "RNA reads vs ATAC fragments in peaks per cell (unfiltered)"
    doc: |
    ...
    - image:
        tab: "Unfiltered"
        Caption: "RNA reads vs ATAC fragments in peaks per cell (unfiltered)"
  ...
  raw_vrlpdbl_plot_png:
    ...
    label: "Percentage of RNA and ATAC doublets (unfiltered)"
    doc: |
    ...
    - image:
        tab: "Unfiltered"
        Caption: "Percentage of RNA and ATAC doublets (unfiltered)"
  ...
  fltr_cell_cnts_plot_png:
    type: File?
    outputSource: sc_multiome_filter/fltr_cell_cnts_plot_png
  ...
  fltr_umi_mito_plot_png:
    type: File?
    outputSource: sc_multiome_filter/fltr_umi_mito_plot_png
  ...
  fltr_rna_atac_cnts_plot_png:
    ...
    label: "RNA reads vs ATAC fragments in peaks per cell (filtered)"
    doc: |
      RNA reads vs ATAC fragments
      in peaks per cell.
      Filtered.
    ...
    - image:
        tab: "Filtered"
        Caption: "RNA reads vs ATAC fragments in peaks per cell (filtered)"
  ...
  fltr_vrlpdbl_plot_png:
    ...
    label: "Percentage of RNA and ATAC doublets (filtered)"
    doc: |
      Percentage of RNA and ATAC doublets.
      Filtered.
      PNG format.
    ...
    - image:
        tab: "Filtered"
        Caption: "Percentage of RNA and ATAC doublets (filtered)"
  ...
  sc_report_html_file:
    type: File?
    outputSource: sc_multiome_filter/sc_report_html_file
    label: "Analysis log"
    doc: |
      Tehcnical report.
      HTML format.
  ...
  sc_multiome_filter_stdout_log:
    ...
    label: "Output log"
    doc: |
      Stdout log from the sc_multiome_filter step.
  ...
  sc_multiome_filter_stderr_log:
    ...
    label: "Error log"
    doc: |
      Stderr log from the sc_multiome_filter step.
...
steps:
  ...
  folder_pdf_plots:
    ...
    in:
      input_files:
        source:
        - sc_multiome_filter/all_plots_pdf
