...
s:name: "Trim Galore RNA-Seq pipeline paired-end SMARTer strand specific"
label: "Trim Galore SMARTer RNA-Seq pipeline paired-end strand specific"
s:alternateName: "Run RNA-Seq BioWardrobe basic analysis with SMARTer strand specific pair-end data file"

s:downloadUrl: https://raw.githubusercontent.com/datirium/workflows/master/workflows/trim-rnaseq-pe-smarter-dutp.cwl
...
# doc:
#   $include: ../descriptions/trim-rnaseq-pe-smarter-dutp.md
