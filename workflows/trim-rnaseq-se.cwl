...
s:name: "Trim Galore RNA-Seq pipeline single-read"
label: "Trim Galore RNA-Seq pipeline single-read"
s:alternateName: "Run RNA-Seq BioWardrobe basic analysis with single-end data file"

s:downloadUrl: https://raw.githubusercontent.com/datirium/workflows/master/workflows/trim-rnaseq-se.cwl
...
# doc:
#   $include: ../descriptions/trim-rnaseq-se.md
